...
namespace Microsoft.TMSN {
	...
	/// </summary>
	public class JoinRankingTSVFile <D>: RankingTSVFile <D> 
    where D: IData
    {
		/// <summary>
		...
		public JoinRankingTSVFile(string baseFileName, string secondaryFileName, D data) :
			base(new JoinLineReader(baseFileName, secondaryFileName), data) {
		}		
