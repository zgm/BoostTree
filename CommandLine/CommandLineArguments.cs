...
//////////////////////////////////////////////////////////////////////////////
namespace Microsoft.TMSN.CommandLine
{
	using System;
	...
	public sealed class Parser
	{
		...
		private class Argument
		{
			...
			{
                if (value is string || value is int || value is uint || value is float || value is double 
                    || value is long || value is ulong || value is short || value is ushort || value.GetType().IsEnum)
				{
